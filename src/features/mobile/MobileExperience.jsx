  ...
  return (
    <header className="d4m-header">
      ...
      <button className="d4m-brand" type="button" onClick={onHome} aria-label="Go to SigmaValue home">
        <img src={theme === "light" ? "/branding/logo-mobile-light.png" : "/branding/logo-mobile-dark.png"} alt="SigmaValue" />
      </button>
...
function Hero({ onExplore }) {
  return (
    <main className="d4m-hero">
      ...
      <div className="d4m-hero-mark"><img src="/branding/logo-alt.png" alt="" /></div>
