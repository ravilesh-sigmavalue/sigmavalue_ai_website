...
function createNatureElements(THREE, width, settingsRef) {
  ...
  const treeTexture = texLoader.load('/scene/tree-light.png');
  ...
  const grassTextures = [
    texLoader.load('/scene/grass-stone-1.png'),
    texLoader.load('/scene/grass-stone-2.png'),
    texLoader.load('/scene/grass-stone-3.png'),
    texLoader.load('/scene/grass-stone-4.png'),
    texLoader.load('/scene/grass-stone-5.png'),
    texLoader.load('/scene/grass-stone-6.png'),
  ];
...
function WebGLBackground({ chapters, active, theme, settingsRef: externalSettingsRef }) {
  ...
  useEffect(() => {
    ...
    const logoTexture = new THREE.TextureLoader().load('/branding/logo.png');
