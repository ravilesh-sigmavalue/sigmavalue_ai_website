...
function useChapterScroll(count) {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e) => {
      if (e.defaultPrevented || document.querySelector(".modal.show .super-agent-modal, .modal.show .enterprise-ai-modal")) return;
    ...
    const handleKeyDown = (e) => {
      if (document.querySelector(".modal.show .super-agent-modal, .modal.show .enterprise-ai-modal")) return;
