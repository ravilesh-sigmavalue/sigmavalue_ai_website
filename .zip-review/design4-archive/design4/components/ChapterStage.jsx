...
import { AgentPlatformModal } from "../../design2/components/AgentPlatformModal";
import { EnterpriseAIModal } from "../../design2/components/EnterpriseAIModal";
...
} from "../../design2/components/ServiceConstellation";
...
function ChapterStage({ chapters, active, theme }) {
  ...
  return (
    <div id="content">
      ...
      <AgentPlatformModal
        show={exploreCard === 0}
        onHide={() => setExploreCard(null)}
        groups={agentGroups}
        theme={theme}
      />
      <EnterpriseAIModal
        show={exploreCard !== null && exploreCard !== 0 && exploreCard !== 2 && exploreCard !== 3}
        onHide={() => setExploreCard(null)}
        variant={exploreCard === 1 ? "connected" : "default"}
        {...(exploreModalContent[exploreCard] || {})}
      />
      <CrossIndustryModal
        show={exploreCard === 2}
        onHide={() => setExploreCard(null)}
        {...exploreModalContent[2]}
      />
